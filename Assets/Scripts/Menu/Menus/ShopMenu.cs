...
public class ShopMenu : MonoBehaviour
{
    ...
    public void LoadSkinLocks()
    {
        ...
        lockedText.Add("Achieve a <color=#00C9FF>Total Distance Traveled</color> of <color=#11DC58>1,000</color>");
        ...
        lockedText.Add("Clear <color=#11DC58>20</color> <color=#00C9FF>Total Universes</color>");
        lockedText.Add("Clear <color=#11DC58>30</color> <color=#00C9FF>Total Universes</color>");
        lockedText.Add("Clear <color=#11DC58>3</color> <color=#00C9FF>Easy Universes</color>");
        lockedText.Add("Clear <color=#11DC58>10</color> <color=#00C9FF>Easy Universes</color>");
        lockedText.Add("Clear <color=#11DC58>3</color> <color=#00C9FF>Normal Universes</color>");
        lockedText.Add("Clear <color=#11DC58>10</color> <color=#00C9FF>Normal Universes</color>");
        lockedText.Add("Clear <color=#11DC58>3</color> <color=#00C9FF>Hard Universes</color>");
        lockedText.Add("Clear <color=#11DC58>10</color> <color=#00C9FF>Hard Universes</color>");
        lockedText.Add("Clear <color=#11DC58>3</color> <color=#00C9FF>universes</color> <color=#E54B4B>without being hit</color>");
        lockedText.Add("Clear <color=#11DC58>10</color> <color=#00C9FF>universes</color> <color=#E54B4B>without being hit</color>");
        lockedText.Add("Clear <color=#11DC58>1</color> <color=#00C9FF>Easy Universe</color> <color=#E54B4B>without being hit</color>");
        lockedText.Add("Clear <color=#11DC58>3</color> <color=#00C9FF>Easy Universes</color> <color=#E54B4B>without being hit</color>");
        lockedText.Add("Clear <color=#11DC58>1</color> <color=#00C9FF>Normal Universe</color> <color=#E54B4B>without being hit</color>");
        lockedText.Add("Clear <color=#11DC58>3</color> <color=#00C9FF>Normal Universes</color> <color=#E54B4B>without being hit</color>");
        lockedText.Add("Clear <color=#11DC58>1</color> <color=#00C9FF>Hard Universe</color> <color=#E54B4B>without being hit</color>");
        lockedText.Add("Clear <color=#11DC58>3</color> <color=#00C9FF>Hard Universes</color> <color=#E54B4B>without being hit</color>");  
        ...
        if (PlayerPrefs.HasKey("Quickest Universe"))
        {
            if (PlayerPrefs.GetInt("Quickest Universe") < 400)
            {
                ...
                if (PlayerPrefs.GetInt("Quickest Universe") < 300)
                {
                    ...
                    if (PlayerPrefs.GetInt("Quickest Universe") < 200)
                    {
                        unlockCount += 1;
        ...
        if (PlayerPrefs.GetInt("Total Universes", 0) >= 10)
        {
            ...
            if (PlayerPrefs.GetInt("Total Universes", 0) >= 20)
            {
                unlockCount += 1;
                locks[17].SetActive(false);
                if (PlayerPrefs.GetInt("Total Universes", 0) >= 30)
                {
                    unlockCount += 1;
        ...
        if (PlayerPrefs.GetInt("Easy Universes", 0) >= 3)
        {
            unlockCount += 1;
            locks[19].SetActive(false);
            if (PlayerPrefs.GetInt("Easy Universes", 0) >= 10)
            {
                unlockCount += 1;
                locks[20].SetActive(false);
            }
        }
        if (PlayerPrefs.GetInt("Normal Universes", 0) >= 3)
        {
            unlockCount += 1;
        ...
        if (PlayerPrefs.GetInt("Hard Universes", 0) >= 3)
        {
            unlockCount += 1;
            locks[23].SetActive(false);
            if (PlayerPrefs.GetInt("Hard Universes", 0) >= 10)
            {
                unlockCount += 1;
                locks[24].SetActive(false);
            }
        }
        if (PlayerPrefs.GetInt("Hitless Universes", 0) >= 3)
        {
            unlockCount += 1;
            locks[25].SetActive(false);
            if (PlayerPrefs.GetInt("Hitless Universes", 0) >= 10)
            {
                unlockCount += 1;
        ...
        if (PlayerPrefs.GetInt("Hitless Easy Universes", 0) >= 1)
        {
            ...
            if (PlayerPrefs.GetInt("Hitless Easy Universes", 0) >= 3)
            {
                unlockCount += 1;
        ...
        if (PlayerPrefs.GetInt("Hitless Normal Universes", 0) >= 1)
        {
            ...
            if (PlayerPrefs.GetInt("Hitless Normal Universes", 0) >= 3)
            {
                unlockCount += 1;
        ...
        if (PlayerPrefs.GetInt("Hitless Hard Universes", 0) >= 1)
        {
            ...
            if (PlayerPrefs.GetInt("Hitless Hard Universes", 0) >= 3)
            {
                unlockCount += 1;

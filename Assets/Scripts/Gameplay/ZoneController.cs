...
public class ZoneController : MonoBehaviour
{
    ...
    void DetectDifficulty()
    {
        ...
        {
            GameManager.instance.zone = 19;
        }
        else
        {
            GameManager.instance.zone = 20;
        }
    }
